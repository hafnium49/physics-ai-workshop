...
> scripts/05_challenge.pyを実行してライブ配信を開始して。

ブラウザでボールの動きを観察してください。デフォルトのPID（Kp=2, Kd=0）でボールがどう動くか確認します。

### ステップ2 — ベースラインスコアを測定する

Ctrl+Cでシミュレーションを停止し、Claudeに伝えてください：

> scripts/04_survival_map.pyを実行して維持マップを表示して。
...
> 05_challenge.pyのkdを0.5に設定して。

Claudeがファイルを編集します。次にClaudeに伝えてください：

> scripts/04_survival_map.py --controller scripts/05_challenge.py を実行して維持マップを表示して。
