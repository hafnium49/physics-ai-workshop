...
3 levels of increasing difficulty to test PID robustness:
...
parser.add_argument("--level", type=int, default=1, choices=[1, 2, 3],
                    help="Challenge level 1-3 (default: 1)")
...
parser.add_argument("--freq", type=float, default=0.5,
                    help="Oscillation frequency for Level 3 (default: 0.5 Hz)")
...
def run_one_attempt(level, rng, max_duration=None):
    ...
    max_duration : float or None
        Max duration in seconds. None means 10s.
    """
    ...
    # Level 3: oscillation parameters
